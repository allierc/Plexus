...
ring is the half that was not: the arrows that carry a \emph{finding} back to the agent that
chooses the next edits. There should be a bundle. There is one, added this week. The Supervisor's
steer, the Interpreter's causal descriptions and Evolution's refinement reach nothing, so a round
cannot be changed by what the round found. Drawing it is what made the shape obvious: fourteen
agents, and the only thing they share is the direction of travel.\par}
