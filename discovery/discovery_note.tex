...
about our own past arithmetic. Every number we hold was taken with at least one instrument since
proved wrong; the product of this round is a frontier of compositions we have \emph{seen work},
measured with instruments we are entitled to believe. It cost one agent call and 34 seconds to
submit.

\textbf{What to watch}: whether the chemistry stays finite, the Collector's holes, and whether any
run reports a protruding cell --- which would be the first in the project's history.
\end{phasebox}
