...
refuses. Seven of the nine run every round, and the two that never run are the interesting ones ---
the Grounder is the only agent that knows what the target is, and its absence is why a 27-run batch
started at 150 cells against a paper that says 200. Wiring it is Phase 3(a).
