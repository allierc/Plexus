...
[`lateral`]{.op-badge} [`acts on: organ`]{.op-badge} [`prediction: none`]{.op-badge}
...
- **Acts on** &mdash; `organ` (the set the operator acts on).
- **Reads** &mdash; &ndash;
