...
Other **structural** operators: [`protein_project`](protein_project.qmd), [`protein_express`](protein_express.qmd), [`organelle_project`](organelle_project.qmd), [`organelle_express`](organelle_express.qmd), [`junction_myosin`](junction_myosin.qmd), [`cytokinetic_ring`](cytokinetic_ring.qmd).
