...
|---|---|---|
| `interface_weighted` | `interface_weighted` MODEL of cell_chem_diffuse -- the OKUDA finite-volume form, and the MISSING HALF of the chemistry<->shape coupling. | `vol_floor` (0.05), `w_cap` (4.0), `vertex_set` ("vertex") |
