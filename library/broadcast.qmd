...
[`broadcast`]{.op-badge} [`acts on: particle`]{.op-badge} [`prediction: none`]{.op-badge}
...
|---|---|---|
| `stiffness` | containment_strength | **required** |
...
**Mechanism** &mdash; [`containment`]{.op-badge} [`hierarchical_coupling`]{.op-badge} [`spring`]{.op-badge}  
