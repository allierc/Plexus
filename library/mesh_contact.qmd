...
|---|---|---|
| `centre` | `mesh_contact` as it has always worked, named: the surface indexed by DIRECTION from a centre. | &ndash; |
| `spatial_hash` | The same contact, with candidates found by POSITION instead of by direction. | &ndash; |
