...
|---|---|---|
| `spectral` | The same diffusion, stepped exactly instead of approximately: in Fourier space the heat equation is diagonal, so one step is a multiplication rather than a stencil. | &ndash; |
