---
title: "compartment"
subtitle: "One PIECE of a subcellular compartment: a single membrane patch, a single mitochondrion, a single Golgi cisterna."
---

::: {.op-head}
![](../figures/icons/set.png){.op-logo}

[`set`]{.op-badge} [`depth: 1`]{.op-badge}
...
- **Depth** &mdash; `1` (0 = leaf, higher = container).
...
[`src/plexus/operators/cell_ops.py`](https://github.com/allierc/Plexus/blob/main/src/plexus/operators/cell_ops.py)
