---
title: "pacemaker"
subtitle: "A clock: one periodic scalar p(t), shared by every operator that reads it."
---
...
A clock: one periodic scalar p(t), shared by every operator that reads it.
:::
...
Other **field** operators: [`hash_encoding`](hash_encoding.qmd), [`diffuse`](diffuse.qmd), [`decay`](decay.qmd), [`playback`](playback.qmd), [`activation_pulse`](activation_pulse.qmd), [`mpm_grid_update`](mpm_grid_update.qmd).
