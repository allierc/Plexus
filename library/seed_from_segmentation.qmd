...
subtitle: "Build a hierarchy from a measured instance segmentation: the cells are the ones in the image, not a lattice, and each carries its own material."
---
...
Build a hierarchy from a measured instance segmentation: the cells are the ones in the image, not a lattice, and each carries its own material.
:::
...
Other **seed** operators: [`set_material`](set_material.qmd), [`ecm_seed`](ecm_seed.qmd), [`seed_ecm`](seed_ecm.qmd), [`seed_mesh`](seed_mesh.qmd), [`mesh_seed`](mesh_seed.qmd), [`seed_positions`](seed_positions.qmd).
