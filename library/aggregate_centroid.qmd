...
Other **aggregate** operators: [`cell_geometry`](cell_geometry.qmd), [`paint_children`](paint_children.qmd), [`reaction_rate`](reaction_rate.qmd), [`metabolite_flux`](metabolite_flux.qmd).
