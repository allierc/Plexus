---
title: "cohesion"
subtitle: "Cohesion, the first boids steering rule: accelerate toward the mean position of the live neighbours, which is what holds a flock together against the other two rules."
---
...
Cohesion, the first boids steering rule: accelerate toward the mean position of the live neighbours, which is what holds a flock together against the other two rules.
:::
...
Other **lateral** operators: [`attraction_repulsion`](attraction_repulsion.qmd), [`squared_law`](squared_law.qmd), [`separation`](separation.qmd), [`velocity_align`](velocity_align.qmd), [`alignment`](alignment.qmd), [`stillinger_weber`](stillinger_weber.qmd).
