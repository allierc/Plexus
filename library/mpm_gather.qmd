...
|---|---|---|
| `differentiable` | G2P writing a fresh state table instead of advecting in place. | &ndash; |
| `torch_loop27` | The gather as 27 sequential passes over the stencil instead of one batched reduction. | &ndash; |
| `warp` | The gather as one Warp kernel. | &ndash; |
