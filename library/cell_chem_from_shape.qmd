...
|---|---|---|
| `apical_area` | The chemistry listens to APICAL AREA: crowding and density sensing. | &ndash; |
| `pressure` | The chemistry listens to VOLUME-ELASTIC PRESSURE. | &ndash; |
| `tension` | The chemistry listens to CORTICAL TENSION: mechanotransduction. | &ndash; |
