---
title: "cell_grow"
subtitle: "Cell_grow (cell, structural): CELL rest-VOLUME growth -- the biological growth primitive."
---
...
- **Kind** &mdash; $|S|$ **Structural**: change the node set (divide / die / spawn).
...
|---|---|---|
| `rate` | growth_rate | 0.0 |
| `target` | size_inhibition | 4.0 |
| `aniso` | growth_anisotropy | 0.0 |
| `tip` | tip_localization | 0.0 |
| `stress_gain` | mechano_inhibition | 0.0 |
| `child` | &ndash; | "mpm_particle" |
| `mode` | &ndash; | "isotropic" |
| `offset` | &ndash; | 0.01 |
| `prestretch` | &ndash; | 1.0 |
| `axis` | &ndash; | None |
...
```yaml
operators:
  - {op: cell_grow, at: cell}
```

## Mechanism-search tags

**Mechanism** &mdash; [`tissue_growth`]{.op-badge} [`rest_volume_growth`]{.op-badge} [`anisotropic_growth`]{.op-badge} [`budding`]{.op-badge}  

## Related operators

Other **structural** operators: [`cell_divide`](cell_divide.qmd).

## Source

[`src/plexus/operators/cell_grow.py`](https://github.com/allierc/Plexus/blob/main/src/plexus/operators/cell_grow.py) &mdash; the registered operator.
