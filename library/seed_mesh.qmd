...
|---|---|---|
| `apicobasal` | `apicobasal` IMPLEMENTATION of seed_mesh -- the same epithelium, seeded WITH ITS THICKNESS. | `h0` (0.4), `sep_block` ("sep"), `apical` ("out"), `v0_from` ("wedge"), `ref_frame` (0) |

## Minimal spec

```yaml
operators:
  - {op: seed_mesh, at: vertex}
```
...
Other **seed** operators: [`seed_from_segmentation`](seed_from_segmentation.qmd), [`set_material`](set_material.qmd), [`ecm_seed`](ecm_seed.qmd), [`seed_ecm`](seed_ecm.qmd), [`mesh_seed`](mesh_seed.qmd), [`seed_cycle`](seed_cycle.qmd).
