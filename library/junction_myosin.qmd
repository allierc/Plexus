...
|---|---|---|
| `two_pool` | The junctional belt as a RECEIVER rather than a recruiter: it is fed by the medioapical pool, holds a conserved amount, and its density follows from that amount and its length. | `tau_jun` (20.0), `myo_new_rel` (True) |
...
Other **structural** operators: [`topo_record`](topo_record.qmd), [`protein_project`](protein_project.qmd), [`protein_express`](protein_express.qmd), [`organelle_project`](organelle_project.qmd), [`organelle_express`](organelle_express.qmd), [`cytokinetic_ring`](cytokinetic_ring.qmd).
