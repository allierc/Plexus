---
title: "mpm_block"
subtitle: "A material point of a solid block: identical continuum state to the matrix's `mpm_particle` -- the deformation gradient F, the affine velocity C, mass, the Lame parameters mu and lambda, and the rest volume p_vol."
---
...
[`src/plexus/operators/ecm_ops.py`](https://github.com/allierc/Plexus/blob/main/src/plexus/operators/ecm_ops.py)
