---
title: "organ"
subtitle: "A body its effectors move: a pose, the rate that pose is changing, and the pose being commanded."
---
...
[`src/plexus/operators/muscle_ops.py`](https://github.com/allierc/Plexus/blob/main/src/plexus/operators/muscle_ops.py)
