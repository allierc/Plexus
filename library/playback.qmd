---
title: "playback"
subtitle: "A scalar field *prescribed* from external data (currently a"
---
...
A scalar field *prescribed* from external data (currently a
:::
...
Other **field** operators: [`diffuse`](diffuse.qmd), [`decay`](decay.qmd), [`pacemaker`](pacemaker.qmd), [`activation_pulse`](activation_pulse.qmd), [`mpm_grid_update`](mpm_grid_update.qmd).

## Source

[`src/plexus/operators/prescribed_field.py`](https://github.com/allierc/Plexus/blob/main/src/plexus/operators/prescribed_field.py) &mdash; the registered operator.
