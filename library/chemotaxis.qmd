...
Other **exchange** operators: [`deposit`](deposit.qmd), [`sense`](sense.qmd), [`sense_3d`](sense_3d.qmd), [`pulse_to_contraction`](pulse_to_contraction.qmd), [`pulse_to_active_stress`](pulse_to_active_stress.qmd), [`apply_material_map`](apply_material_map.qmd).
