...
|---|---|---|
| `differentiable` | The material update with F rebound rather than written in place. | &ndash; |
| `warp` | The deformation-gradient update and material response as one Warp kernel, elastic and liquid branches both. | &ndash; |
