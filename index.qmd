...
- **[Simulations](experiment.qmd)** — the core operator families as one-per-family
  clips (interaction, boids, active matter, slime, MLS-MPM, inverse-square, strange
  attractors), plus a maze-foraging colony optimized end-to-end.
