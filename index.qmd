...
discrete entities. State moves through just four operators — **lateral** (within
a set), **aggregate** (up the containment hierarchy), **broadcast** (down it),
and **exchange** (between sets and fields). Complex simulations emerge from
composing a few primitive operations.
