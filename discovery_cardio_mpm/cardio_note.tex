...
\textbf{So no model may be scored above 0.705, and one that is has fitted the difference between
one beat and the next.} The second line matters as much: even two real beats of the same tissue
...
\textbf{What that settles.} The rhythm and the strength of the beat are properties of the tissue.
\textbf{The fine spatial pattern is not: it is substantially a property of the tracking software.}
