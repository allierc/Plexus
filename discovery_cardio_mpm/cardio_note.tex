...
\item \textbf{Use the simulations we already own} --- see the separate task list below. Ten of
the seventy-one MPM runs in \code{graphs\_data/material} drive tissue with active traction of a
\emph{pattern we chose}, each with its full trajectory and its spec. These are loops whose ground
truth is their own recipe, and they are already computed.
