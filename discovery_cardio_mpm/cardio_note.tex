...
\textbf{Still to do.}
\begin{itemize}
\item \textbf{Migrate the seven stale specs and re-run them}, then check the new trajectory against
the archived one. This does three things at once: it makes the corpus reproducible, it tests
whether that operator merge was actually behaviour-preserving --- nobody has ever checked --- and
it exercises the rename defect on a case where we know the answer.
