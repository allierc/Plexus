...
\begin{scope}[shift={(5.6,0)}]
  ...
  \node[sig,minimum size=2.2mm] (n1) at (-0.10,-0.62) {};
  \node[sig,minimum size=2.2mm] (n2) at ( 0.22,-0.52) {};
  \begin{scope}[on background layer]
    \node[cellbox,fit=(n1)(n2)] (cellB) {};
  \end{scope}
  \node[lab,right=1.2mm of cellB] {neuron};
...
\begin{scope}[shift={(16.1,0)}]
  \node[tiny] (o1) at (-0.22,0.24) {};
  \node[tiny] (o2) at ( 0.04,0.38) {};
  \node[tiny] (o3) at ( 0.28,0.16) {};
  \begin{scope}[on background layer]
    \node[cellbox,fit=(o1)(o2)(o3)] (org) {};
  \end{scope}
  \node[ttl] at (0.02,-1.78) {organism};
  \node[lab] at (0.02,-2.14) {$S_3$};
\end{scope}
