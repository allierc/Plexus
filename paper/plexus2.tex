...
\begin{figure}[h]
\centering
\includegraphics[width=0.92\textwidth]{fig_hier.pdf}
...
\begin{itemize}
\item \href{https://github.com/DamCB/tyssue}{tyssue} --- the true-vertex (AVM) Python framework; the mechanical substrate of our prototype.
