...
Thus the transport pair \code{agent\_to\_mpm}/\code{mpm\_to\_agent} is really
\code{scatter}/\code{gather} (one particle$\leftrightarrow$grid transfer, wired by
\code{from:}/\code{to:}), and \code{pulse\_to\_active\_stress}/\code{pulse\_to\_contraction}
