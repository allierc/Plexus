...
representations. Biological models can therefore be assembled from reusable operators, 
systematically compared, differentiated against observations, and progressively 
extended as new mechanisms are discovered. In sum, Plexus provides a common language 
in which simulation, inverse modelling, and hypothesis generation become successive stages 
of model discovery.
