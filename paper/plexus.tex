...
(\code{motion}, \code{interaction}, \code{polarity}, \code{fields}, \code{mechanics},
\code{mpm}, \code{coupling}, \code{hierarchy}, \code{growth}, \code{topology}). The family
...
biological events. A single check, \code{tools/audit\_operator\_registry.py}, enforces the
