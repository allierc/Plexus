...
adhesions are plaques $\sim\!350$ nm across on $\sim\!700$ nm centres joined to the cell across a
$\sim\!30$ nm gap \cite{kanchanawong2010}, so an adhesion is three times \emph{wider} than the sheet is
thick and a third as long; and the sheet is $10$ to $100$ times stiffer than the stroma outside it,
not equal to it.
