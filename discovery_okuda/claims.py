...
def render(cur, spec, path=None):
    ...
    L = ["# Knowledge — the claim ledger, rendered\n",
         ...
         # A CLEAN START HANDS OUT THE OLD RUN NAMES AGAIN. `campaign_loop._repoint_evidence`
         # prefixes every citation of the campaign being archived, because otherwise the ledger
         # silently reattributes the old campaign's evidence to the new campaign's `r001_02`.
