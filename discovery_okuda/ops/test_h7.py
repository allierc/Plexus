...
def build(with_rd):
    ...
    ops = [{"op": "mesh_seed", "at": "vertex", "n_cells": 150, "radius": R, "jitter": J,
    ...
    ops += [{"op": "cell_grow", "at": "vertex", "cell_set": "cell", "rate": 0.03,
            ...
            {"op": "cell_divide", "at": "vertex", "factor": 2.0, "reset_noise": 0.12, "cycle_cv": 0.15, "p0": 3.72,
