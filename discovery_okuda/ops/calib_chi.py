...
def build(chi, d_h):
    ...
    ops = [{"op": "mesh_seed", "at": "vertex", "n_cells": N, "radius": 5.0, "jitter": 0.16, "p0": 3.9, "seed": 0, "before_frame": 1},
           ...
           {"op": "cell_chem_diffuse", "at": "cell", "d_a": 0.05, "d_h": d_h, "chi": chi},
           {"op": "cell_chem_react", "at": "cell", "model": "brusselator", "gamma": 2.0, "A": 1.0, "B": 3.0},
           {"op": "cell_mechanics", "at": "vertex", "p0": 3.9, "K_A": 1.0, "K_P": 1.0, "Gamma": 0.05, "Lambda": 0.2,
            "K_V": 1.0, "K_R": 0.4, "mu": 1.0, "dt": 0.02, "relax_iters": 8, "eta": 0.08, "cap_frac": 0.12}]
    sched = ["mesh_seed", "cell_geometry", "cell_neighbours", "cell_chem_seed", "cell_chem_diffuse", "cell_chem_react", "cell_mechanics"]
