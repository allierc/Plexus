...
def build(rho, rate=0.02, gamma=2.0, vth=1.3, mdf=0.02, dev=2):
    ...
    ops = [{"op": "mesh_seed", "at": "vertex", "n_cells": CELLS, "radius": R, "jitter": J, "p0": 3.90, "seed": SEED, "before_frame": 1, "vseed_cv": 0.15},
           ...
           {"op": "cell_chem_react", "at": "cell", "model": "brusselator", "gamma": gamma, "A": 1.0, "B": 3.0},
           # locked body (rho=0) so growth is fully localised to the red cells; only rate (coupling strength) varies
           {"op": "cell_grow", "at": "vertex", "cell_set": "cell", "rate": rate, "a_sw": 2.5, "hill": 4.0, "rho": rho, "vth_frac": vth},
           {"op": "cell_mechanics", "at": "vertex", "p0": 3.90, "K_A": 1.0, "K_P": 1.0, "Gamma": 0.2, "Lambda": 0.6, "K_V": 4.0, "K_R": 0.02, "mu": 1.0, "dt": 0.02, "relax_iters": 30, "eta": 0.08, "cap_frac": 0.12},
           {"op": "edge_flip", "at": "vertex", "l_th_frac": 0.28, "every": 1, "max_flips": 40},
           {"op": "cell_divide", "at": "vertex", "factor": 2.0, "reset_noise": 0.12, "cycle_cv": 0.15, "p0": 3.90, "every": dev, "max_div": 40, "max_div_frac": mdf, "cell_set": "cell", "min_cycle": 4, "max_cycle": 30},
