...
No mechanics, no growth, no division -- only cell_neighbours + cell_chem_diffuse + cell_chem_react on a rigid
...
sys.path.insert(0,'/workspace/Plexus/discovery_okuda/ops'); sys.path.insert(0,'/workspace/Plexus/src')
