#!/usr/bin/env python
"""cell_chem_from_shape -- THE MISSING ARROW: the tissue's shape feeds back into its chemistry.

WHAT IS MISSING WITHOUT IT
================================================================================================
Our model runs one way. The chemistry patterns the shell (cell_chem_react -> cell_grow) and
...
is clean. Same pattern the substrate already uses three times over: cell_chem_react
(gray_scott | gierer_meinhardt | brusselator), cell_mechanics (default | monolayer), cell_chem_diffuse
