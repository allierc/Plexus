...
(V3), plus that it registered as the `monolayer` implementation of the cell_mechanics contract."""
import numpy as np, torch
from mesh_ops import build_sphere_mesh, face_geometry_3d
import monolayer_ops as ML
from monolayer_ops import monolayer_geometry_3d, _monolayer_energy_core
...
print("=== registration ===")
c = get_contract("cell_mechanics")
print(f" cell_mechanics implementations: {sorted(c.implementations)}  (kind={c.kind}, family={c.family})")
