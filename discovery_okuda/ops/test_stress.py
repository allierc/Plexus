...
def build(frames):
    ...
    ops = [{"op": "mesh_seed", "at": "vertex", "n_cells": 150, "radius": 5.0, "jitter": 0.18,
           ...
           {"op": "cell_grow", "at": "vertex", "rate": 0.003, "every": 1, "rho": 1.0, "a_sw": 0.0, "vth_frac": 64, "conserve_amount": False},
           ...
           {"op": "cell_divide", "at": "vertex", "factor": 2.0, "reset_noise": 0.12, "p0": 3.72, "every": 2,
