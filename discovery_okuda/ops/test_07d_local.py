...
class Rig07d(Rig07c):
    ...
    def __init__(self, split_budget=150, edge_trigger=1.45, every=10, **P):
        super().__init__(**P)
        ...
        self._ref = LocalRefiner(self.sheet)
        self._splits = 0
    ...
    def _epi_anchor(self, t):
        ...
        n = self._ref.refine_where(self.local_target, max_splits=self.split_budget)
        if n:
            self._splits += n
...
def main():
    ...
    rig = Rig07d(N0=a.N0, split_budget=a.budget, every=a.every, **P)
