...
def make(coral, frames, dt):
    ...
    ops += [{"op": "cell_grow", "at": "vertex", "cell_set": "cell", "rate": 0.03, "a_sw": 50.0, "hill": 4.0, "rho": 1.0, "vth_frac": 1.4},
            {"op": "cell_mechanics", "at": "vertex", "p0": P0, "K_A": 1.0, "K_P": 1.0, "Gamma": GAM, "Lambda": LAM, "K_V": K_V, "K_R": 0.4, "mu": 1.0, "dt": dt, "relax_iters": 30, "eta": 0.08, "cap_frac": 0.12},
            ...
            {"op": "edge_flip", "at": "vertex", "l_th_frac": 0.35, "every": 4, "engine_clock": True, "max_flips": 30},
            {"op": "cell_divide", "at": "vertex", "factor": 2.0, "reset_noise": 0.12, "cycle_cv": 0.15, "p0": P0, "every": 4, "engine_clock": True, "max_div": 12, "max_div_frac": 0.03, "cell_set": "cell", "min_cycle": 4, "max_cycle": 12},
