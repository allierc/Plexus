"""topology_ops -- 3D face DIVISION on the closed spherical half-edge mesh (the 3D sibling of
topology_ops_2d.face_divide_line). A cell divides by a septum: two of its edges are split at their
...
Operators here are pure functions; the plexus operator `cell_divide` (in mesh_ops) drives them.
"""
