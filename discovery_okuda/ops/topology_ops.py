"""topology_ops -- MOVED to `plexus.models.topology`.
...
New code should import from `plexus.models.topology`.
"""
from plexus.models.topology import *          # noqa: F401,F403
from plexus.models.topology import (          # noqa: F401  the underscored names okuda reaches for
    _check_closed,
    _edge_face_map,
    _insert_after)
