...
import ops_2d          # noqa: F401  seed_mesh + shape_energy
import topology_ops_2d  # noqa: F401  face_growth + face_divide + t1_transition
from ops_2d import build_honeycomb, face_polygons
from topology_ops_2d import rings_from_flat
...
def run_all(only=None):
    ...
    for name, p0, rate, ratio in presets():
        ...
        try:
            ...
            from topology_ops_2d import ring_valid
