...
WHY THIS EXISTS. `plate_confine` is a projection: the plate is infinitely rigid, so it cannot be
...
@register_operator("block_seed", family="growth", set="particle", kind="seed")
