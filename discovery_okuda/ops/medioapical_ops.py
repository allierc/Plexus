"""medioapical_ops -- MOVED to `plexus.operators.junction_ops`.
...
New code should import from `plexus.operators.junction_ops`.
"""
from plexus.operators.junction_ops import *          # noqa: F401,F403
from plexus.operators.junction_ops import (          # noqa: F401  the underscored names okuda reaches for
    _face_carry)
