"""mesh_contact_ops -- MOVED to `plexus.operators.contact_ops`.
...
New code should import from `plexus.operators.contact_ops`.
"""
from plexus.operators.contact_ops import *          # noqa: F401,F403
from plexus.operators.contact_ops import (          # noqa: F401  the underscored names okuda reaches for
    _bins_of,
    _grid,
    _neighbours)
