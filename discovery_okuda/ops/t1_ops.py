"""t1_ops -- surface T1 NEIGHBOUR-EXCHANGE (reversible network reconnection) on the closed
spherical half-edge mesh (the epithelial vesicle). The 3D sibling of topology_ops_2d.t1_flip: the
...
Pure functions here; the plexus operator `edge_flip` drives them (mirrors t1_transition in 2D).
"""
