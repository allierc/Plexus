...
def make():
    ...
    ops = [{"op": "mesh_seed", "at": "vertex", "n_cells": 150, "radius": R, "jitter": J, "p0": 3.72, "seed": SEED, "before_frame": 1, "vseed_cv": 0.15},
           ...
           {"op": "cell_chem_diffuse", "at": "cell", "d_a": 0.08, "d_h": 0.16, "chi": 1.3},                    # Gray-Scott coral
           ...
           {"op": "cell_mechanics", "at": "vertex", "p0": 3.72, "K_A": 1.0, "K_P": 1.0, "Gamma": 0.1, "Lambda": 0.5, "K_V": 4.0, "K_R": 0.4, "mu": 1.0, "dt": 1.0, "relax_iters": 26, "eta": 0.08, "cap_frac": 0.12},
