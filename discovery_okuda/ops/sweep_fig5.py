...
def _one(cfgp):
    ...
    try:
        ...
        ops = [{"op": "mesh_seed", "at": "vertex", "n_cells": n_cells, "radius": RADIUS, "jitter": JITTER,
               ...
               {"op": "cell_chem_seed", "at": "cell", "mode": "cones", "n_spots": P["spots"], "cone_deg": P["cone"]},
               {"op": "cell_grow", "at": "vertex", "cell_set": "cell", "rate": P["grow"],
               ...
               {"op": "cell_divide", "at": "vertex", "factor": 2.0, "reset_noise": 0.12, "cycle_cv": 0.4, "p0": 3.90,
