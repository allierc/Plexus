...
def build(chi, rho, vth, rate, a_sw, gamma=2.0):
    ...
    ops = [{"op": "mesh_seed", "at": "vertex", "n_cells": CELLS, "radius": R, "jitter": J,
           ...
           {"op": "cell_chem_diffuse", "at": "cell", "d_a": 0.05, "d_h": 0.7, "chi": chi},
           ...
           {"op": "cell_divide", "at": "vertex", "factor": 2.0, "reset_noise": 0.12, "cycle_cv": 0.15, "p0": 3.90,
