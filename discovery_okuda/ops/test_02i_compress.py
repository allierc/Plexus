...
class Press:
    ...
    The material, the seeding and the damping are 02h's: `ecm_seed`'s straight strands of 20
    ...
    def __init__(self, dev="cuda:0", n_grid=64, ppc=4, E=15.0, nu=0.2, rho=1.0, drag=8.0,
        ...
        # STRANDS, laid the way `ecm_seed` lays them: a centre, a direction, `per` points along it,
