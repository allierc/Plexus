...
BEFORE; apply the exact Hertwig long-axis edge-midpoint septum (divide_face_3d, as cell_divide does);
...
from topology_ops import rings_from_flat_3d, divide_face_3d
import torch
...
def build():
    ...
    sched = ["mesh_seed", "cell_grow", "cell_mechanics", "edge_flip"]   # NO divide -> clean mesh
...
# apply the SAME Hertwig long-axis septum as cell_divide
