...
def make(n, frames, coral, relax=30, K_R=0.4, mdf=0.03):
    ...
    ops = [{"op": "mesh_seed", "at": "vertex", "n_cells": n, "radius": R, "jitter": J, "p0": P0, "seed": SEED, "before_frame": 1, "vseed_cv": 0.15},
           {"op": "cell_geometry", "at": "cell"}]
    sched = ["mesh_seed", "cell_geometry"]
    if coral:
        ops += [{"op": "cell_neighbours", "at": "cell"},
                {"op": "cell_chem_seed", "at": "cell", "seed": SEED, "before_frame": 3, "mode": "scatter", "seed_frac": 0.06},
                {"op": "cell_chem_diffuse", "at": "cell", "d_a": 0.08, "d_h": 0.16, "chi": 1.3},
                {"op": "cell_chem_react", "at": "cell", "model": "gray_scott", "F": 0.055, "kk": 0.062, "rate": 1.0}]
        sched += ["cell_neighbours", "cell_chem_seed", "cell_chem_diffuse", "cell_chem_react"]
    ops += [{"op": "cell_grow", "at": "vertex", "cell_set": "cell", "rate": 0.03, "a_sw": 50.0, "hill": 4.0, "rho": 1.0, "vth_frac": 1.4},
            {"op": "cell_mechanics", "at": "vertex", "p0": P0, "K_A": 1.0, "K_P": 1.0, "Gamma": GAM, "Lambda": LAM, "K_V": K_V, "K_R": K_R, "mu": 1.0, "dt": dt, "relax_iters": relax, "eta": 0.08, "cap_frac": 0.12},
            {"op": "edge_flip", "at": "vertex", "l_th_frac": 0.35, "every": 2, "max_flips": 60},
            {"op": "cell_divide", "at": "vertex", "factor": 2.0, "reset_noise": 0.12, "cycle_cv": 0.15, "p0": P0, "every": 2, "max_div": 60, "max_div_frac": mdf, "cell_set": "cell", "min_cycle": 4, "max_cycle": 12},
            {"op": "topo_record", "at": "vertex", "every": 1}]
    sched += ["cell_grow", "cell_mechanics", "edge_flip", "cell_divide", "topo_record"]
