...
import mesh_ops, chem_ops, t1_ops, ckpt  # noqa
...
def build():
    ...
    ops = [{"op": "mesh_seed", "at": "vertex", "n_cells": CELLS, "radius": R, "jitter": J, "p0": 3.90, "seed": SEED, "before_frame": 1, "vseed_cv": 0.15},
           ...
           {"op": "cell_grow", "at": "vertex", "cell_set": "cell", "rate": 0.03, "a_sw": 0.5, "hill": 4.0, "rho": 0.15, "vth_frac": 1.35},
           {"op": "cell_mechanics", "at": "vertex", "p0": 3.90, "K_A": 1.0, "K_P": 1.0, "Gamma": 0.05, "Lambda": 0.2, "K_V": 3.0, "K_R": 0.05, "mu": 1.0, "dt": 1.0, "relax_iters": 45, "eta": 0.08, "cap_frac": 0.12},
           {"op": "edge_flip", "at": "vertex", "l_th_frac": 0.28, "every": 1, "max_flips": 120},
           {"op": "cell_divide", "at": "vertex", "factor": 2.0, "reset_noise": 0.12, "cycle_cv": 0.3, "p0": 3.90, "every": 2, "max_div": 40, "max_div_frac": 0.02, "cell_set": "cell", "min_cycle": 4, "max_cycle": 16},
           {"op": "topo_record", "at": "vertex", "every": 50}]
