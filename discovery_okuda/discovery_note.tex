...
\begin{phasebox}{Phase 8 --- Entities, edges and sweeps: the loop stops being a script \hfill \prog}
...
the sweep arm switched on. \emph{Nothing relaunches until the checker passes.}
\end{phasebox}
