...
#
# QUEUE: ${CLUSTER_QUEUE_PREFIX}a100, not ${CLUSTER_QUEUE_PREFIX}l4. A 50,000-particle 20-frame differentiable tape does not fit an L4's
...
conda run -n connectome-gnn python -m plexus.morph \
    ...
    --out "${3:-${GNN_OUTPUT_ROOT}/graphs_data/si_material}"
