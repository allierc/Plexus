...
![](figures/fig_inverse_evolution.png){fig-align="center"}
...
![**Cells — best methods.** Ground truth vs the two best recoveries (8D position-loss, 8D heading-loss); the recovered agent networks converge onto the target morphology.](figures/fig_inverse_gal_00.png){fig-align="center"}

![**Chemical field — best methods.** The same three runs, drawn as the deposited trail field instead of the agents.](figures/fig_inverse_gal_01.png){fig-align="center"}

![**Cells — baselines.** Ground truth vs the weaker recoveries (4D gradient-descent on field+move, and UCB black-box search).](figures/fig_inverse_gal_02.png){fig-align="center"}

![**Chemical field — baselines.** The baseline recoveries drawn as the trail field.](figures/fig_inverse_gal_03.png){fig-align="center"}
