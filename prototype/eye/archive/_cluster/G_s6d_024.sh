...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.941 0.831 0.678 0.855 0.776 0.385 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
