...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.484 0.138 0.645 0.603 0.592 0.264 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
