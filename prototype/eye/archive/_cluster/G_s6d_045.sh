...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.133 0.374 0.118 0.537 0.481 0.568 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
