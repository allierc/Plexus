...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.562 0.328 0.313 0.916 0.015 0.804 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
