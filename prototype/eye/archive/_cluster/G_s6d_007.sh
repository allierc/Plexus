...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.998 0.086 0.109 0.496 0.042 0.949 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
