...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.916 0.206 0.507 0.345 0.432 0.903 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
