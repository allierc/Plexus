...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.735 0.536 0.551 0.935 0.307 0.646 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
