...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.651 0.41 0.63 0.429 0.901 0.129 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
