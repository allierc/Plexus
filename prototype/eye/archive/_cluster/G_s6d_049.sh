...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.433 0.009 0.246 0.738 0.95 0.337 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
