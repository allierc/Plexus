...
conda run -n connectome-gnn python run_eye_G.py --program pairs --blend "260802_s2_EYE_MUSCLES_MODEL 2.blend" --parts archive/eye_H/blend_parts --k-bone 15000 --out archive/eye_H --label kopt15000 --hold 200 --rest 160 --turns 0 --az 25 --no-movie --device cuda:0
