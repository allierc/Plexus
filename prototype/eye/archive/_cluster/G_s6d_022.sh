...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.261 0.676 0.726 0.34 0.956 0.586 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
