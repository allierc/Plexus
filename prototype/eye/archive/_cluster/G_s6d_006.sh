...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.364 0.847 0.89 0.726 0.744 0.246 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
