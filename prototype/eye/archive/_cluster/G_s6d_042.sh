...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.019 0.641 0.349 0.667 0.321 0.925 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
