...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.851 0.931 0.363 0.365 0.14 0.561 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
