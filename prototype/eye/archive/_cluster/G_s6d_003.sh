...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.605 0.448 0.79 0.8 0.405 0.844 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
