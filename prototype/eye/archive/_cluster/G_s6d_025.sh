...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.322 0.101 0.334 0.117 0.446 0.683 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
