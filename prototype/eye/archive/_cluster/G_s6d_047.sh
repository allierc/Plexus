...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.762 0.055 0.44 0.874 0.547 0.04 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
