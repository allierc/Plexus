...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.837 0.184 0.916 0.974 0.936 0.124 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
