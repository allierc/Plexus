...
conda run -n connectome-gnn python run_eye_G.py --program pairs --hold 200 --rest 160 --stride 3 --inflate 1.1 --embed -0.025 --out archive/eye_H --label pairs_long --turns 0 --az 25 --device cuda:0
