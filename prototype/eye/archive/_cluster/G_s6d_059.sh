...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.723 0.114 0.982 0.511 0.672 0.532 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
