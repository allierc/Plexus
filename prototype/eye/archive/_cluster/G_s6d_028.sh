...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.584 0.702 0.486 0.41 0.671 0.282 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
