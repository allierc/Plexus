...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.345 0.3 0.585 0.83 0.363 0.076 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
