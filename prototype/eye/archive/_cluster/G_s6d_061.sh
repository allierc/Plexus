...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.241 0.17 0.267 0.399 0.194 0.224 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
