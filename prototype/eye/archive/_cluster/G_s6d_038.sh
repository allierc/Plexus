...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.343 0.554 0.14 0.439 0.565 0.515 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
