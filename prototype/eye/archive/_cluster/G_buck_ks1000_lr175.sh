...
conda run -n connectome-gnn python run_eye_G.py --program pairs --eye-youngs 130 --k-bone 5000 --k-sleeve 1000 --lr-strength 1.75 --groups LR --label E130_ks1000_lr175 --hold 200 --rest 160 --turns 0 --az 25 --no-movie --device cuda:0
