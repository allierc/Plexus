...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.443 0.462 0.394 0.328 0.726 0.995 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
