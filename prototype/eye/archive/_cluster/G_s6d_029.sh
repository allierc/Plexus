...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.215 0.494 0.517 0.687 0.123 0.517 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
