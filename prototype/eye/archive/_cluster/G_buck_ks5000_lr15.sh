...
conda run -n connectome-gnn python run_eye_G.py --program pairs --eye-youngs 130 --k-bone 5000 --k-sleeve 5000 --lr-strength 1.5 --groups LR --label E130_ks5000_lr15 --hold 200 --rest 160 --turns 0 --az 25 --no-movie --device cuda:0
