...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.862 0.477 0.167 0.191 0.755 0.637 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
