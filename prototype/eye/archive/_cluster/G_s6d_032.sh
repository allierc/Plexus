...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.824 0.732 0.613 0.581 0.051 0.198 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
