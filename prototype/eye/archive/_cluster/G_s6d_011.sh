...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.672 0.235 0.38 0.642 0.783 0.616 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
