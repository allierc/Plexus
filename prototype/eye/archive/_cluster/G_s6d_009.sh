...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.301 0.428 0.061 0.949 0.221 0.025 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
