...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.702 0.282 0.232 0.294 0.511 0.208 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
