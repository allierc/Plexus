...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.159 0.042 0.869 0.253 0.335 0.175 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
