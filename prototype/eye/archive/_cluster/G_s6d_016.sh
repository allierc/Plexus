...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.774 0.603 0.027 0.697 0.412 0.154 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
