...
conda run -n connectome-gnn python run_eye_G.py --program pairs --hold 200 --rest 160 --stride 3 --contract 100.5 --turns 0 --az 25 --label pairs_long_x15 --device cuda:0
