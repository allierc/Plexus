...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.502 0.572 0.9 0.306 0.811 0.366 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
