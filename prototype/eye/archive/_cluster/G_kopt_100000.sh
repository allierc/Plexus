...
conda run -n connectome-gnn python run_eye_G.py --program pairs --eye-youngs 130 --k-bone 100000 --label E130_kopt100000 --hold 200 --rest 160 --turns 0 --az 25 --no-movie --device cuda:0
