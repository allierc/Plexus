...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.639 0.99 0.841 0.001 0.016 0.053 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
