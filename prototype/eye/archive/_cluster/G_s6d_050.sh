...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.178 0.62 0.657 0.177 0.716 0.007 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
