...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.454 0.883 0.073 0.243 0.356 0.828 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
