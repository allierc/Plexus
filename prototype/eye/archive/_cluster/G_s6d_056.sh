...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.978 0.506 0.428 0.075 0.908 0.874 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
