...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.28 0.221 0.811 0.231 0.087 0.732 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
