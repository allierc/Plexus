...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.564 0.155 0.04 0.021 0.286 0.395 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
