...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.787 0.356 0.69 0.087 0.645 0.716 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
