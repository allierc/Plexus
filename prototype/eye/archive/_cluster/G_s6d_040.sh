...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.898 0.96 0.217 0.986 0.637 0.467 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
