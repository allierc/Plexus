...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.008 0.189 0.184 0.779 0.69 0.756 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
