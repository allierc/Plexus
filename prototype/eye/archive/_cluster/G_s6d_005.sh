...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.118 0.267 0.458 0.158 0.977 0.412 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
