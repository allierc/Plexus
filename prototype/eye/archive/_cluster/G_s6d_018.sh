...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.153 0.796 0.407 0.894 0.6 0.738 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
