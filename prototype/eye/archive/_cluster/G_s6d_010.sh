...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.056 0.942 0.599 0.388 0.488 0.32 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
