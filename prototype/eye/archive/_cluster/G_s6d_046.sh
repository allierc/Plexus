...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.38 0.762 0.534 0.097 0.247 0.774 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
