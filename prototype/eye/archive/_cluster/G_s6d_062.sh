...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.496 0.715 0.823 0.968 0.461 0.433 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
