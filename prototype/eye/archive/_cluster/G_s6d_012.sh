...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.542 0.779 0.15 0.531 0.881 0.878 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
