...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.392 0.341 0.996 0.458 0.866 0.92 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
