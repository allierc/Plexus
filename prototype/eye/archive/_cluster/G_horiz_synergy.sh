...
conda run -n connectome-gnn python run_eye_G.py --program pairs --hold 200 --rest 160 --stride 3 --groups 'LR,SR|MR,IO|LR,SR,SO|MR,IO,IR' --out archive/eye_G --label horiz_synergy --turns 0 --az 25 --device cuda:0
