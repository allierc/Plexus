...
conda run -n connectome-gnn python run_eye_G.py --program pairs --eye-youngs 130 --k-bone 5000 --k-sleeve 2500 --lr-strength 1.15 --groups LR --label E130_milestone_m55 --hold 200 --rest 160 --turns 0 --az 25 --device cuda:0
