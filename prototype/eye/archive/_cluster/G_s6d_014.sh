...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.422 0.586 0.284 0.818 0.069 0.481 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
