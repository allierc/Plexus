...
conda run -n connectome-gnn python run_hold.py --folder archive/eye_G --muscles LR SR MR IR SO IO --level 0.082 0.068 0.707 0.882 0.832 0.829 --hold-s 2.835 --stage 6d --no-movie --device cuda:0
