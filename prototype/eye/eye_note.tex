...
\begin{enumerate}
\item \textbf{Length} --- \code{frac} $0.55\to0.95$, and the rectus origins spread around the
annulus of Zinn. $\theta_{\max}\sim(A/E)(L/R)$, and this is the term the baseline is worst on.
...
\textbf{One at a time, re-probing after each.} Six probe runs per intervention, $\approx$90 minutes.
