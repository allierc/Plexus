...
- **Rung 1 reached** — first composition robustly in the real regime across seeds + parameter basin: `cleft_induce+confine+react_rd` (turing-like (Menshykau-Iber), rate 1.00). 13 compositions are in-regime.

## Established  (sufficient ∧ robust ∧ has a necessary operator)
- **focal-ECM (Yamada)** — composition `cleft_induce+tissue_grow` emerges (rate 1.00); necessary operator(s): `cleft_induce`.
- **focal-ECM under confinement** — composition `cleft_induce+confine` emerges (rate 0.67); necessary operator(s): `cleft_induce`.
...
- `cleft_induce+interface_relax+react_rd` → **no growth operator (cannot develop)** (class branch-like, rate 0.00).
- `cleft_induce+interface_relax+react_rd+tissue_grow` → **branch-like phenotype, not in real regime** (class branch-like, rate 0.17).
...
## Open
- `cleft_induce` — partial (rate 0.33, class branch-like).
- `cleft_induce+interface_relax` — partial (rate 0.33, class branch-like).
- `cleft_induce+confine+tissue_grow` — partial (rate 0.33, class branch-like).
- `cleft_induce+react_rd` — partial (rate 1.00, class branch-like).
- `cleft_induce+react_rd+tissue_grow` — partial (rate 0.83, class branch-like).
- `cleft_induce+confine+react_rd` — partial (rate 0.83, class branch-like).
- `cleft_induce+react_rd` — partial (rate 1.00, class branch-like).
- `cleft_induce+interface_relax+react_rd` — partial (rate 0.33, class branch-like).
- `cleft_induce+react_rd+tissue_grow` — partial (rate 0.83, class branch-like).
...
| --- | --- | --- | --- | --- |
| `cleft_induce+tissue_grow` | focal-ECM (Yamada) | 1.00 | branch-like | duct 0.702 / gen 6 |
| `cleft_induce+interface_relax+tissue_grow` | focal-ECM (Yamada) | 1.00 | branch-like | duct 0.886 / gen 6 |
| `cleft_induce+react_rd` | turing-like (Menshykau-Iber) | 1.00 | branch-like | duct 0.867 / gen 6 |
| `cleft_induce+react_rd` | turing-like (Menshykau-Iber) | 1.00 | branch-like | duct 0.867 / gen 6 |
...
| `cleft_induce+react_rd` | turing-like (Menshykau-Iber) | 1.00 | branch-like | duct 0.867 / gen 6 |
| `cleft_induce+react_rd` | turing-like (Menshykau-Iber) | 1.00 | branch-like | duct 0.867 / gen 6 |
| `cleft_induce+react_rd+tissue_grow` | turing-like (Menshykau-Iber) | 0.83 | branch-like | duct 0.485 / gen 3 |
| `cleft_induce+confine+react_rd` | turing-like (Menshykau-Iber) | 0.83 | branch-like | duct 1.0 / gen 8 |
| `cleft_induce+react_rd+tissue_grow` | turing-like (Menshykau-Iber) | 0.83 | branch-like | duct 0.485 / gen 3 |
| `cleft_induce+confine` | focal-ECM under confinement | 0.67 | branch-like | duct 0.802 / gen 7 |
| `cleft_induce` | focal-ECM (Yamada) | 0.33 | branch-like | duct 0.931 / gen 7 |
| `cleft_induce+interface_relax` | focal-ECM (Yamada) | 0.33 | branch-like | duct 0.414 / gen 5 |
| `cleft_induce+confine+tissue_grow` | focal-ECM under confinement | 0.33 | branch-like | duct 0.846 / gen 8 |
| `cleft_induce+interface_relax+react_rd` | turing-like (Menshykau-Iber) | 0.33 | branch-like | duct 0.86 / gen 6 |
| `cleft_induce+interface_relax+react_rd+tissue_grow` | turing-like (Menshykau-Iber) | 0.17 | branch-like | duct 0.799 / gen 6 |
...
| `cleft_induce+interface_relax+react_rd` | turing-like (Menshykau-Iber) | 0.00 | branch-like | duct 0.86 / gen 6 |
| `cleft_induce+confine+interface_relax+react_rd` | turing-like (Menshykau-Iber) | 0.00 | branch-like | duct 0.742 / gen 7 |
| `cleft_induce+confine+react_rd+tissue_grow` | turing-like (Menshykau-Iber) | 0.00 | no-growth | duct 0.459 / gen 5 |
