...
WHAT IS TESTED HERE is the growth line -- `seed_mesh_3d`, `cell_geometry_3d`, `grow_3d`,
`shape_energy_3d`, `divide_3d`, `reconnect_t1_3d` -- through what it produced: cell number, apical
...
def main():
    ...
    yaml.safe_dump(dict(
        ...
        operators_exercised=["seed_mesh_3d", "cell_geometry_3d", "grow_3d", "shape_energy_3d",
                             "divide_3d", "reconnect_t1_3d", "topo_snapshot_3d"],
