...
The cause is in the log -- **18,134 membrane particles per frame projected by `cell_exclude_3d`**.
...
The membrane receives no force at all. `cell_to_ecm`, the stroma's soft push, is an analytic growing
