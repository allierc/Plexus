...
def running():
    ...
    # RETRY, and a longer timeout. $CLUSTER_SSH hung for minutes at a stretch today -- a direct `bjobs -w`
...
def main():
    ...
    while True:
        ...
        if r is None:
            ...
            # AN EMPTY QUEUE IS NOT THE SAME AS A FINISHED WAVE. When $CLUSTER_SSH hung, the launcher
