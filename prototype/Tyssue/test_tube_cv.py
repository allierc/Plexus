...
def build(grow, rho, vth, K_V, min_cycle, max_cycle):
    ...
    ops = [{"op": "seed_mesh_3d", "at": "vertex", "n_cells": NCELLS, "radius": RADIUS, "jitter": JITTER,
            "p0": 3.90, "seed": SEED, "before_frame": 1, "vseed_cv": 0.4},
           {"op": "cell_geometry_3d", "at": "cell"},
           {"op": "cell_rd_seed", "at": "cell", "mode": "patch", "patch_z": 0.90},
           ...
           {"op": "divide_3d", "at": "vertex", "factor": 2.0, "reset_noise": 0.12, "cycle_cv": 0.4,
