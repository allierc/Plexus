...
large buffer): (1) anti-inversion FILTERED STEP in shape_energy_3d (block moves that push a face toward
signed-volume inversion), (2) LOCAL DAUGHTER RELAX in divide_3d (heal the fresh caps at birth). Hollows
...
import tyssue_ops3d, tyssue_t1_ops3d  # noqa (no RD)
