"""squared_law -- MOVED to `plexus.operators.interaction_ops`.
...
from plexus.operators.interaction_ops import (          # noqa: F401  the underscored names okuda reaches for
    _get_inv_square_sum,
    _inv_square_sum,
    _inv_square_sum_compiled)
