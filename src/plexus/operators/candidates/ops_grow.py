...
@register_operator("repulse", set="particle", kind="lateral", family="interaction")
...
@register_operator("duplicate", set="particle", kind="structural", family="population")
...
@register_operator("skin", set="particle", kind="rewire", family="topology")
class Skin(Operator):
...
@register_operator("ring", set="particle", kind="rewire", family="topology")
class Ring(Operator):
...
@register_operator("spring", set="particle", kind="lateral", family="mechanics")
...
@register_operator("tension", set="particle", kind="lateral", family="mechanics")
...
@register_operator("separate", set="particle", kind="lateral", family="interaction")
...
@register_operator("tissue", set="cell", kind="lateral", family="interaction")
...
@register_operator("mitosis", set="cell", kind="structural", family="population")
