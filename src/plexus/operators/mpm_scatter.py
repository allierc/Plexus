"""mpm_scatter -- MOVED to `plexus.operators.mpm_ops`.
...
New code should import from `plexus.operators.mpm_ops`.
"""
from plexus.operators.mpm_ops import *          # noqa: F401,F403
from plexus.operators.mpm_ops import (          # noqa: F401  the underscored names okuda reaches for
    _polar_higham)
