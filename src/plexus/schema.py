...
def load(path: str) -> Spec:
    ...
    _KNOWN_TYPE_KEYS = {"fraction", "count", "core", "layers", "block",
                        ...
                        "sign", "role", "shape", "form", "aspect", "axis", "hollow", "rotate", "repeat", "pitch", "scatter", "ring", "orient", "fill", "obj"} | used_props  # a neuron type's Dale sign and circuit role (neural_panel)
    for sname, s in raw["sets"].items():
